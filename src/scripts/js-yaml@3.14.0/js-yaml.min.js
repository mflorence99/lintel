  ...
  })(
    {
      ...
      '3': [
        function (e, t, n) {
          ...
          function U(e, t) {
            for (
              var n, i = c.repeat(' ', t), r = 0, o = -1, a = '', s = e.length;
              r < s;
                  ...
                  return (
                    ...
                    (function (e) {
                      for (var t, n, i, r = '', o = 0; o < e.length; o++)
                        ...
                        n <= 57343
                          ? ((r += L(1024 * (t - 55296) + n - 56320 + 65536)),
                            o++)
                          : ((i = l[t]), (r += !i && R(t) ? e[o] : i || L(t)));
                      return r;
                    })(r) +
                    '"'
                  );
          ...
          function X(e, t, n) {
            for (
              var i,
                r,
                o,
                a = n ? e.explicitTypes : e.implicitTypes,
                s = 0,
                c = a.length;
              s < c;
              s += 1
              ...
              if (
                ((r = a[s]).instanceOf || r.predicate) &&
                (!r.instanceOf ||
                  ('object' == typeof t && t instanceof r.instanceOf)) &&
                (!r.predicate || r.predicate(t))
              ) {
                if (((e.tag = n ? r.tag : '?'), r.represent)) {
                  if (
                    ((o = e.styleMap[r.tag] || r.defaultStyle),
                    '[object Function]' === p.call(r.represent))
                  )
                    i = r.represent(t, o);
                  else {
                    if (!u.call(r.represent, o))
                      throw new d(
                        '!<' +
                          r.tag +
            ...
            if (
              ...
              if (
                  ...
                  : ((function (e, t, n) {
                      for (
                        ...
                        (o = ''),
                          ...
                          (r = n[(i = c[u])]),
                          ee(e, t, i, !1, !1) &&
                            (1024 < e.dump.length && (o += '? '),
                            (o +=
                              e.dump +
                              (e.condenseFlow ? '"' : '') +
                              ':' +
                              (e.condenseFlow ? '' : ' ')),
                            ee(e, t, r, !1, !1) && (a += o += e.dump));
                      (e.tag = s), (e.dump = '{' + a + '}');
                    })(e, t, e.dump),
                    c && (e.dump = '&ref_' + s + ' ' + e.dump));
                ...
                i && 0 !== e.dump.length
                  ...
                  : ((function (e, t, n) {
                      for (
                        var i = '', r = e.tag, o = 0, a = n.length;
                        o < a;
                        o += 1
                      )
                        ee(e, t, n[o], !1, !1) &&
                          (0 !== o && (i += ',' + (e.condenseFlow ? '' : ' ')),
                          (i += e.dump));
                      (e.tag = r), (e.dump = '[' + i + ']');
                    })(e, l, e.dump),
                    c && (e.dump = '&ref_' + s + ' ' + e.dump));
          ...
          function ne(e, t) {
            var n = new D((t = t || {}));
            return (
              n.noRefs || te(e, n), ee(n, 0, e, !0, !0) ? n.dump + '\n' : ''
            );
          }
          (t.exports.dump = ne),
            (t.exports.safeDump = function (e, t) {
              return ne(e, c.extend({ schema: r }, t));
            });
        },
        {
          './common': 2,
      ...
      '4': [
        function (e, t, n) {
          ...
          (((i.prototype = Object.create(
            Error.prototype
          )).constructor = i).prototype.toString = function (e) {
            var t = this.name + ': ';
            return (
        ...
        function (e, t, n) {
          ...
          function Y(e, t, n) {
            for (var i = 0, r = e.input.charCodeAt(e.position); 0 !== r; ) {
              ...
              if (!O(r)) break;
              for (
                q(e), r = e.input.charCodeAt(e.position), i++, e.lineIndent = 0;
                32 === r;
          ...
          function R(e) {
            ...
            return (45 !== n && 46 !== n) ||
              ...
              ((t += 3), 0 !== (n = e.input.charCodeAt(t)) && !F(n))
              ? void 0
              : 1;
          }
          function B(e, t) {
            ...
            if (34 === p) {
              for (
                e.kind = 'scalar',
                  ...
                  e.position++,
                  n = i = e.position;
                0 !== (p = e.input.charCodeAt(e.position));
                ...
                if (92 === p) {
                  if (
                    (L(e, n, e.position, !0),
                    O((p = e.input.charCodeAt(++e.position))))
                  )
                    Y(e, !1, t);
                  else if (p < 256 && f[p]) (e.result += d[p]), e.position++;
                  else if (
                    0 <
                    (a = 120 === (l = p) ? 2 : 117 === l ? 4 : 85 === l ? 8 : 0)
                  ) {
                    for (r = a, o = 0; 0 < r; r--)
                      (p = e.input.charCodeAt(++e.position)),
                        (u = void 0),
                  ...
                  O(p)
                    ? (L(e, n, i, !0), B(e, Y(e, !1, t)), (n = i = e.position))
          ...
          function W(e, t) {
            ...
            for (
              ...
              0 !== i && 45 === i && F(e.input.charCodeAt(e.position + 1));
                  ...
                  ? (s &&
                            ...
                            if (
                              ...
                              if (e.line === o) {
                                for (s = e.input.charCodeAt(e.position); E(s); )
                                  s = e.input.charCodeAt(++e.position);
                                if (58 === s)
                                  F((s = e.input.charCodeAt(++e.position))) ||
                                    N(
                                      e,
                    ...
                    (function (e, t) {
                      ...
                      for (
                        ...
                        if (
                          (Y(e, !0, t),
                          (m = e.input.charCodeAt(e.position)) === r)
                        )
                          return (
                            e.position++,
                            (e.tag = f),
                        ...
                        p ||
                          ...
                          (o = a = !1),
                          63 === m &&
                            F(e.input.charCodeAt(e.position + 1)) &&
                          ...
                          s
                            ? U(e, i, h, u, c, l)
                            : o
                            ? i.push(U(e, null, h, u, c, l))
                            : i.push(c),
                          Y(e, !0, t),
                          44 === (m = e.input.charCodeAt(e.position))
                    ...
                    : ((a &&
                        (function (e, t) {
                          ...
                          for (e.kind = 'scalar', e.result = ''; 0 !== f; )
                            if (
                              43 === (f = e.input.charCodeAt(++e.position)) ||
                              45 === f
                            )
                              w === a
                                ? (a = 43 === f ? k : C)
                          ...
                          if (E(f)) {
                            ...
                            if (35 === f)
                              for (
                                ;
                                !O((f = e.input.charCodeAt(++e.position))) &&
                                0 !== f;
                          ...
                          for (; 0 !== f; ) {
                            for (
                              q(e),
                                e.lineIndent = 0,
                                f = e.input.charCodeAt(e.position);
                              (!c || e.lineIndent < u) && 32 === f;

                            )
                              e.lineIndent++,
                                (f = e.input.charCodeAt(++e.position));
                            if (
                              (!c && e.lineIndent > u && (u = e.lineIndent),
                              O(f))
                            )
                              l++;
                            else {
                      ...
                      P(e, p)
                        ...
                        ? (function (e, t, n) {
                            ...
                            if (
                              ...
                              ((63 !== f && 45 !== f) ||
                                !(
                                  F((i = e.input.charCodeAt(e.position + 1))) ||
                                  (n && _(i))
                                ))
                            ) {
                              for (
                                ...
                                if (58 === f) {
                                  ...
                                  if (F(e.input.charCodeAt(e.position - 1)))
                                    break;
                                } else {
                                  if (
                                    (e.position === e.lineStart && R(e)) ||
          ...
          function $(e, t) {
            ...
            for (
              -1 !== i &&
                ((n.position = i), N(n, 'null byte is not allowed in input')),
                n.input += '\0';
            ...
            for (; n.position < n.length - 1; )
              !(function (e) {
                ...
                for (
                  ...
                  for (
                    ...
                    if (35 === r) {
                      for (
                        ;
                        0 !== (r = e.input.charCodeAt(++e.position)) && !O(r);
                ...
                Y(e, !0, -1),
                  ...
                  K(e, e.lineIndent - 1, b, !1, !0),
                  Y(e, !0, -1),
                  e.checkLineBreaks &&
                    s.test(e.input.slice(o, e.position)) &&
            ...
            (t.exports.safeLoadAll = function (e, t, n) {
              return (
                'object' == typeof t &&
                  ...
                  void 0 === n &&
                  ((n = t), (t = null)),
                H(e, t, g.extend({ schema: o }, n))
              );
            }),
            (t.exports.safeLoad = function (e, t) {
              return G(e, g.extend({ schema: o }, t));
            });
        },
        {
          './common': 2,
        ...
        function (e, t, n) {
          ...
          (c.DEFAULT = null),
            (c.create = function (e, t) {
              ...
              return new c({ include: n, explicit: i });
            }),
            (t.exports = c);
        },
        ...
        function (e, t, n) {
          ...
          t.exports = new i('tag:yaml.org,2002:omap', {
            ...
            resolve: function (e) {
              if (null === e) return !0;
              for (
                var t, n, i, r = [], o = e, a = 0, s = o.length;
                a < s;
                a += 1
              ) {
                if (((t = o[a]), (i = !1), '[object Object]' !== u.call(t)))
                  return !1;
                for (n in t)
                  if (c.call(t, n)) {
                    if (i) return !1;
          ...
          t.exports = new i('tag:yaml.org,2002:timestamp', {
            ...
            construct: function (e) {
              var t,
                ...
                u = null,
                l = p.exec(e);
              if ((null === l && (l = f.exec(e)), null === l))
                throw new Error('Date resolve error');
              if (((t = +l[1]), (n = l[2] - 1), (i = +l[3]), !l[4]))
              ...
              return (
                l[9] &&
                  ((u = 6e4 * (60 * +l[10] + +(l[11] || 0))),
                  '-' === l[9] && (u = -u)),
                (s = new Date(Date.UTC(t, n, i, r, o, a, c))),
