...
import { BRACKET_CLOSE } from './parse';
import { BRACKET_OPEN } from './parse';
import { COLON } from './array';
import { COMMA } from './parse';
import { CURLY_BRACKET_CLOSE } from './parse';
import { CURLY_BRACKET_OPEN } from './parse';
import { EMPTY } from './parse';
import { PREFIX_AFTER } from './parse';
import { PREFIX_AFTER_ALL } from './parse';
import { PREFIX_AFTER_COLON } from './array';
import { PREFIX_AFTER_COMMA } from './array';
import { PREFIX_AFTER_PROP } from './array';
import { PREFIX_AFTER_VALUE } from './array';
import { PREFIX_BEFORE } from './array';
import { PREFIX_BEFORE_ALL } from './parse';
import { UNDEFINED } from './array';

import { isArray } from './core-util-is';
import { isFunction } from './core-util-is';
import { isNumber } from './core-util-is';
...
// @param {string} indent
// @param {string} gap
function base_stringify(key, holder, gap) {
