...
export const PREFIX_AFTER = 'after';
export const PREFIX_AFTER_ALL = 'after-all';

export const BRACKET_OPEN = '[';
export const BRACKET_CLOSE = ']';
export const CURLY_BRACKET_OPEN = '{';
export const CURLY_BRACKET_CLOSE = '}';
export const COMMA = ',';
export const EMPTY = '';
export const MINUS = '-';
